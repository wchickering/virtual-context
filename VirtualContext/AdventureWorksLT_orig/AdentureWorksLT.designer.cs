...
namespace AdventureWorksLT
{
	...
	public partial class AdentureWorksLTDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteSalesOrderDetail(SalesOrderDetail instance);
		...
		public AdentureWorksLTDataContext() : 
				base(global::AdventureWorksLT.Properties.Settings.Default.AdventureWorksLTConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public AdentureWorksLTDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public AdentureWorksLTDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public AdentureWorksLTDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public AdentureWorksLTDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnModifiedDateChanged();
		...
		[Column(Storage="_rowguid", DbType="UniqueIdentifier NOT NULL", IsDbGenerated=true)]
		[DataMember(Order=21)]
    ...
    partial void OnModifiedDateChanged();
		...
		public EntitySet<SalesOrderHeader> SalesOrderHeaders1
		{
			...
			{
				if ((this.serializing 
							&& (this._SalesOrderHeaders1.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
    ...
    partial void OnModifiedDateChanged();
		...
		[Association(Name="Product_SalesOrderDetail", Storage="_SalesOrderDetails", ThisKey="ProductID", OtherKey="ProductID")]
    ...
    partial void OnModifiedDateChanged();
		...
		[Association(Name="ProductCategory_ProductCategory", Storage="_ProductCategories", ThisKey="ProductCategoryID", OtherKey="ParentProductCategoryID")]
		...
		public EntitySet<ProductCategory> ProductCategories
		{
			...
			{
				if ((this.serializing 
							&& (this._ProductCategories.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
		...
		[Association(Name="ProductCategory_ProductCategory", Storage="_ProductCategory1", ThisKey="ParentProductCategoryID", OtherKey="ProductCategoryID", IsForeignKey=true)]
    ...
    partial void OnModifiedDateChanged();
		...
		[Association(Name="ProductDescription_ProductModelProductDescription", Storage="_ProductModelProductDescriptions", ThisKey="ProductDescriptionID", OtherKey="ProductDescriptionID")]
		...
		public EntitySet<ProductModelProductDescription> ProductModelProductDescriptions
		{
			...
			{
				if ((this.serializing 
							&& (this._ProductModelProductDescriptions.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
    ...
    partial void OnModifiedDateChanged();
		...
		[Association(Name="ProductModel_ProductModelProductDescription", Storage="_ProductModelProductDescriptions", ThisKey="ProductModelID", OtherKey="ProductModelID")]
		[DataMember(Order=7, EmitDefaultValue=false)]
		public EntitySet<ProductModelProductDescription> ProductModelProductDescriptions
		{
			get
    ...
    partial void OnModifiedDateChanged();
		...
		[Association(Name="ProductDescription_ProductModelProductDescription", Storage="_ProductDescription", ThisKey="ProductDescriptionID", OtherKey="ProductDescriptionID", IsForeignKey=true)]
		...
		[Association(Name="ProductModel_ProductModelProductDescription", Storage="_ProductModel", ThisKey="ProductModelID", OtherKey="ProductModelID", IsForeignKey=true)]
		public ProductModel ProductModel
		{
			get
			{
    ...
    partial void OnModifiedDateChanged();
		...
		[Association(Name="Product_SalesOrderDetail", Storage="_Product", ThisKey="ProductID", OtherKey="ProductID", IsForeignKey=true)]
